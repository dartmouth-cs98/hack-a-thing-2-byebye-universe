...
function playGame(faces,rows,cols,width){
  ...
  function flipTile(event){
    console.log("flipTile called for canvas");
    for (var i = 0; i < tiles.length; i++){
...
//     console.log("clearing canvas on "+canvas+" and "+ctx);

//     var game = playGame()
//     resetGlobalVariables();

//     ctx.canvas.removeEventListener('click', function(event){
//       flipTile(event);
//     });
